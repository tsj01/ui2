...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  ...
  <div class="x-col" xid="col5"></div></div></div></div></div> 
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-xs btn-only-label" label="增行" xid="btnNew" style="background-color:#FFFFFF;color:#1E90FF;height:24px;color:1E90FF;font-size:small;vertical-align:middle;border-style:solid solid solid solid;border-width:1px 1px 1px 1px;width:60px;" target="contentOrder" onClick="btnAddRowClick">
    <i xid="i11"></i>
