...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column label="loginid" name="loginid" type="String" xid="xid2"></column>
  <column label="名称" name="name" type="String" xid="xid3"></column>
  <column label="部门" name="dname" type="String" xid="xid4"></column>
  <column label="电话" name="tel" type="String" xid="xid5"></column></div></div>  
  ...
  <div xid="div10" class="input-group-btn"><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-sm btn-only-icon" label="button" xid="button4" icon="icon-android-search" onClick="{operation:'factData.refresh'}">
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row6" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#C0C0C0;">
   <div class="x-col x-col-50" xid="col6">
    <label xid="label2" style="text-align:center;width:100%;"><![CDATA[姓名]]></label></div> 
   <div class="x-col" xid="col7">
    <label xid="label3" style="text-align:center;width:100%;"><![CDATA[电话]]></label></div> 
   ...
   <div class="x-col x-col-50" xid="col27"><div component="$UI/system/components/justep/output/output" class="x-output" xid="output12" bind-ref='ref("name")' style="text-align:center;padding-top:5px"></div></div>
   <div class="x-col" xid="col28" style="width:70%;"><div component="$UI/system/components/justep/output/output" class="x-output" xid="output13" bind-ref='ref("tel")' style="text-align:center;padding-top:5px"></div></div>
