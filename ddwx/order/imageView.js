define(function(require){
	...
	var Model = function(){
		this.callParent();
		this.showImgFolder = justep.Bind.observable(false);  //justep.Bind.observable(kldCfg.Dd.customParams.recv_cameraonly!=='是');
	};
	...
	Model.prototype.uploadFile = function(file,uploadCallback){
	    	var me = this;
	        //图片方向角 added by lzk 
            ...
            var uploadPic = function(file, id) {
                /* 上传图片 */
                kldBase.uploadFile({
					url : "/mobile",
					action : "uploadImage",
	        ...
	        for (var i = 0; i < files.length; i++) {
	            ...
	            if (file.type.indexOf("image") === 0) {
	                if (file.size >= 1024 * 1024 * 10) {
	                    ...
	                    me.uploadFile(file,function(imgRows){
	...
	Model.prototype.initPhotoSwipe = function(sliders,idx,rowCanRecv) {
	    ...
	    if(me.showImgFolder.get()){
	    	...
	    	canDel = rowCanRecv&&me.params.canRecv;
	    }
