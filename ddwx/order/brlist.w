...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column label="简称" name="shortname" type="String" xid="xid2"></column>
  <column label="名称" name="brname" type="String" xid="xid3"></column>
  <column label="地址" name="braddr" type="String" xid="xid4"></column>
  <column label="定位地址" name="locateaddr" type="String" xid="xid5"></column>
  <column label="机构分类" name="brcatg" type="String" xid="xid6"></column></div></div>  
  ...
  <div xid="div10" class="input-group-btn"><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-sm btn-only-icon" label="button" xid="button4" icon="icon-android-search" onClick="{operation:'factData.refresh'}">
   ...
   <div class="x-col" xid="col7">
    <label xid="label3" style="text-align:center;width:100%;"><![CDATA[名称]]></label></div> 
   ...
   <div class="x-col x-col-33" xid="col27"><div component="$UI/system/components/justep/output/output" class="x-output" xid="output12" bind-ref='ref("shortname")' style="text-align:center;padding-top:5px"></div></div>
   <div class="x-col" xid="col28" style="width:70%;"><div component="$UI/system/components/justep/output/output" class="x-output" xid="output13" bind-ref='ref("brname")' style="padding-top:5px"></div></div>
