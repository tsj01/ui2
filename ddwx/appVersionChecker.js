	...
	VersionChecker.prototype.check = function(){
		...
		if(cordova.getAppVersion){	
			cordova.getAppVersion.getVersionNumber(function (currentVersion) {
				require(['./appVersion_in_server.js?v='+new Date().getTime()],function(version_info){
					if(version_info){
						versionInfo = version_info;
						VersionChecker.prototype.currentVersion = currentVersion;
						VersionChecker.prototype.version = versionInfo[self.env].version;
